...
public  class Room {
	...
	public SensorPoints getSensorPoints(int roomID)
	{
		switch(ROOMS.values()[roomID])
		{
			...
			case Room107:
				return new SensorPoints(250, 500);				
			case Room108:
				return new SensorPoints(100, 150);				
			case Room109:
				return new SensorPoints(175, 500);				
			case Room110:
				return  new SensorPoints(175, 375);				
			case Room111:
				return  new SensorPoints(100, 150);				
			case Room112:
				return  new SensorPoints(100, 150);				
			case Room113:
				return  new SensorPoints(100, 150);				
			case Room114:
				return new SensorPoints(150, 200);				
			case Room115:
				return new SensorPoints(200, 200);				
			case Room116:
				return new SensorPoints(250, 200);				
			case RoomW:
				return new SensorPoints(315, 375);				
			case RoomStairs:
				return new SensorPoints(450, 375);				
			case RoomM:
				return new SensorPoints(625, 375);				
			case Room121:
				return new SensorPoints(700, 375);				
			case RoomKitchen:
				return new SensorPoints(775, 375);				
			case Room118:
				return new SensorPoints(875, 375);				
			case Room117:
				return new SensorPoints(875, 500);				
			case Room117L:
				return new SensorPoints(775, 500);				
			case Room120:
				return new SensorPoints(725, 475);				
			case Room122:
				return new SensorPoints(690, 475);				
			case Room123:
				return new SensorPoints(655, 475);				
			case Room126:
				return new SensorPoints(610, 475);				
			case RoomLobby:
				return new SensorPoints(520, 475);				
			case Room104:
				return new SensorPoints(380, 475);				
			case Room105:
				return new SensorPoints(315, 475);				
			case Room129:
				return new SensorPoints(520, 250);				
			case Room129M:
				return new SensorPoints(520, 175);				
			case Room129A:
				return new SensorPoints(465, 175);				
			case Room129B:
				return new SensorPoints(575, 175);				
			default:
				return new SensorPoints(0, 0);
			}
	}
